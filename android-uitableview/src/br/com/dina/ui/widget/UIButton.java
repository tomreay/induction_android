...
public class UIButton extends LinearLayout {
	...
	public UIButton(Context context, AttributeSet attrs) {
		...
		mTitle = a.getString(R.styleable.UIButton_utitle);
		mSubtitle = a.getString(R.styleable.UIButton_usubtitle);
		mImage = a.getResourceId(R.styleable.UIButton_uimage, -1);
